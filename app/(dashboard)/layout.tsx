...
import { LayoutDashboard, FolderKanban, MessageSquare, ShieldCheck, LogOut } from 'lucide-react';
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-[#fafafa] text-black flex flex-col md:flex-row overflow-hidden relative transition-colors duration-500">
            ...
            {/* Sidebar */}
            <aside className="w-full md:w-64 p-6 flex flex-col gap-8 z-20 transition-all duration-300 bg-rgba(255, 255, 255, 0.9) backdrop-blur-3xl border-r border-[#c20000]/10 text-[#1a1a1a] shadow-[10px_0_40px_rgba(0,0,0,0.02)]">
